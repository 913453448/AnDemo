...
/**
 * author：yinqingy
 * date：2016-11-21 17:15
 * blog：http://blog.csdn.net/vv_bug
 * desc：平移+插值器测试
 */

public class InterpolatorActivity3_translate extends AppCompatActivity {
    private GridView mGridView;
    private TextView tv_anim;
    private TextView tv_desc;
    private List<Map<String, Object>> datas = new ArrayList<>();
    private TranslateAnimation translateAnimation= new TranslateAnimation(Animation.RELATIVE_TO_SELF,0,Animation.RELATIVE_TO_SELF,0,Animation.RELATIVE_TO_PARENT,1.0f,Animation.RELATIVE_TO_SELF,0);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        translateAnimation.setDuration(2000);
        setContentView(R.layout.activity_interpolator_activity3_translate);
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    translateAnimation.setInterpolator((Interpolator) ((Class) datas.get(position).get("CLASS")).newInstance());
