...
public class InterpolatorActivity3_scale extends AppCompatActivity {
    private GridView mGridView;
    private TextView tv_anim;
    private TextView tv_desc;
    private List<Map<String, Object>> datas = new ArrayList<>();
    private ScaleAnimation scaleAnimation= new ScaleAnimation(0,1.0f,0,1.0f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
